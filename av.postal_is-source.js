...
/*
  ...
  and copy-paste the resulting string into the `d` variable above:
      ...
      document.body.innerHTML
        ...
        var output = compact
                        .map(function(val){ return val.join('|'); }) // flatten the nested arrays
                        .reverse()
                        .join(';');
